...
```json
"usingComponents": {
  "uab-icon": "@vant/weapp/icon/index"
}
```
...
```html
<uab-icon name="close" />
<uab-icon name="https://b.yzcdn.cn/vant/icon-demo-1126.png" />
```
...
```html
<uab-icon name="chat" dot />
<uab-icon name="chat" info="9" />
<uab-icon name="chat" info="99+" />
```
...
<uab-icon class-prefix="my-icon" name="extra" />
```
...
| class-prefix | 类名前缀 | _string_ | `uab-icon` |
